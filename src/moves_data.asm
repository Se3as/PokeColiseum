...
moves:
    ...
    dd 3, 2, 65,   ; icefang, type: ice, 65 damage *temporalmente tipo agua
    dd 4, 2, 110,  ; Hydro Pump, type: water, 110 damage
    dd 5, 0, 80,   ; Dragon Claw, type: Dragon, 80 damage *temporalmente tipo normal
...
.found_type:
    mov eax, [rsi + rdx + 4]     ; Devuelve el tipo (ahora sí, desde moves)
    ret
